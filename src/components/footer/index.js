    ...
    return (
      <Fragment>
        <div className="footer">
          <div className="social-row">
            <ul className="social-list">
              <li className="social-item">
                <a href="https://github.com/daniel-bevziuc" target="_blank" rel='noreferrer noopener'>
              ...
              <li className="social-item">
                <a href="https://www.linkedin.com/in/daniel-bevziuc-899780171/" target="_blank" rel='noreferrer noopener'>
          ...
          <p className="footer-text-bottom">© Copyright 2019. All Right Reserved By Daniel.</p>
        </div>
      </Fragment>
    );
  }
