              ...
              <div className="contact-list-block">
                <ul className="contact-list">
                  <li className="contact-list-item">
                    ...
                    <p className="contact-text-left"><a href='tel:+447500454480'>(+44) 7500 4544 80</a></p>
                  </li>
                  <li className="contact-list-item">
                    ...
                    <p className="contact-text-left"><a href='mailto:bevziuc.daniel@gmail.com'>bevziuc.daniel@mail.com</a></p>
                  </li>
                  <li className="contact-list-item">
